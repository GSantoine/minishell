...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parse_opening_singlequote.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: agras <agras@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/07 18:11:37 by agras             #+#    #+#             */
/*   Updated: 2022/08/07 15:19:08 by agras            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	isolate_right(t_prog *prog, t_token *token, char *line)
{
	...
	if (*line != '\0')
	{
		...
		if (token_add_right_child(&token, token_new(data, OPEN_SQUOTES,
					token->master_type, token->mask)) == FATAL_ERR)
			ft_exit(prog, NULL, "Memory allocation failded\n");
