...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parse_closing_doublequote.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: agras <agras@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/07 18:44:56 by agras             #+#    #+#             */
/*   Updated: 2022/08/07 14:32:56 by agras            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	isolate_left(t_prog *prog, t_token *token, char *line)
{
	...
	if (token_add_left_child(&token, token_new(data, DQUOTES,
